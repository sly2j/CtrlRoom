    ...
    namespace vme {
        namespace master_impl {
            ...
            template <addressing_mode A>
                struct dispatch_read<A, transfer_mode::MD32> {
                    template <class Master>
                    static unsigned call(
                            const Master& m,
                            const typename address_spec<A>::ptr_type address,
            ...
            template <addressing_mode A>
                struct dispatch_write<A, transfer_mode::MD32> {
                    template <class Master>
                    static unsigned call(
                            const Master& m,
                            const typename address_spec<A>::ptr_type address,
            ...
            template <addressing_mode A>
                struct dispatch_read<A, transfer_mode::MBLT> {
                    template <class Master>
                    static unsigned call(
                            const Master& m,
                            const typename address_spec<A>::ptr_type address,
            ...
            template <addressing_mode A>
                struct dispatch_write<A, transfer_mode::MBLT> {
                    template <class Master>
                    static unsigned call(
                            const Master& m,
                            const typename address_spec<A>::ptr_type address,
            ...
            template <addressing_mode A>
                struct dispatch_read<A, transfer_mode::U3_2eVME> {
                    template <class Master>
                    static unsigned call(
                            const Master& m,
                            const typename address_spec<A>::ptr_type address,
            ...
            template <addressing_mode A>
                struct dispatch_write<A, transfer_mode::U3_2eVME> {
                    template <class Master>
                    static unsigned call(
                            const Master& m,
                            const typename address_spec<A>::ptr_type address,
            ...
            template <addressing_mode A>
                struct dispatch_read<A, transfer_mode::U6_2eVME> {
                    template <class Master>
                    static unsigned call(
                            const Master& m,
                            const typename address_spec<A>::ptr_type address,
            ...
            template <addressing_mode A>
                struct dispatch_write<A, transfer_mode::U6_2eVME> {
                    template <class Master>
                    static unsigned call(
                            const Master& m,
                            const typename address_spec<A>::ptr_type address,

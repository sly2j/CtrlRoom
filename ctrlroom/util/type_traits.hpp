...
struct is_container<
    std::unordered_map<Key, T, Hash, Pred, Alloc> > : std::true_type {};
// std::unordered_multimap
template <class Key, class T, class Hash, class Pred, class Alloc>
struct is_container<
    std::unordered_multimap<Key, T, Hash, Pred, Alloc> > : std::true_type {};
// std::unordered_set
template <class Key, class Hash, class Pred, class Alloc>
struct is_container<
    std::unordered_set<Key, Hash, Pred, Alloc> > : std::true_type {};
// std::unordered_multiset
template <class Key, class Hash, class Pred, class Alloc>
struct is_container<
    std::unordered_multiset<Key, Hash, Pred, Alloc> > : std::true_type {};
// std::vector
template <class T, class Alloc>
